            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="color: <?php if ($pageTitle == "Kontaktovat"){echo "#1faae5";}?>"href="#"><span class="fa fa-phone" style="color: <?php if ($pageTitle == "Kontaktovat"){echo "#1faae5";}?>"></span> Kontaktovat</a>
                        </li>
                    </ul>
                </div>
            </div>
